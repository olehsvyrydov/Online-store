...
public class CatalogController {
    ...
    public String getAllProducts(
            ...
            Model model) {
        AllItemsModel listItems = catalogService.findAllItems(pageNumber, pageSize, searchString, sorting);
        model.addAttribute("items", listItems.getProductList());
        model.addAttribute("search", searchString);
        model.addAttribute("sort", sorting);
        model.addAttribute("paging", listItems.getPaging());
        return "main";
    }
